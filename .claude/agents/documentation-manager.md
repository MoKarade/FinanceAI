...
## ⭐ KEYSTONE — `docs/SESSION_HANDOVER.md` (à CHAQUE merge, non optionnel)
...
3. **Autres MAJ attendues au push** (en plus du handover KEYSTONE ci-dessus) : `docs/BACKLOG.md` (cocher les ID livrés + ajouter les découvertes), `CHANGELOG.md` (entrée datée si user-facing), CLAUDE.md (leçon apprise), `docs/A_FAIRE_MOI.md` (blocage humain découvert).
