...
5. **PII / vie privée (Loi 25 + RGPD)** : minimisation (ne collecter que le nécessaire), conservation justifiée, consentement (aucune mesure d'audience tierce : Google Analytics retiré le 24/09/2026, [S5-SANS-GA]), droit à l'effacement/export, `errorLogger` scrub bien montants + secrets. Une donnée personnelle qui sort de l'appareil sans chiffrement ni consentement = finding.
