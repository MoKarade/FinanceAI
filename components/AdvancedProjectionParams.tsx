                        ...
                        {projection.stressTestEnabled && (
                            <>
                                <div>
                                    ...
                                    <Input id="app-stressTestYear" type="number" value={projection.stressTestYear ?? 5} onChange={e => updateProj('stressTestYear', Number(e.target.value))} accent="warning" />
                                </div>
                                <div>
                                    <label htmlFor="app-stressTestDrop" className="text-tiny text-ink-300">Chute bourse (%)</label>
                                    <Input id="app-stressTestDrop" type="number" value={projection.stressTestDrop ?? 30} onChange={e => updateProj('stressTestDrop', Number(e.target.value))} accent="warning" />
                                </div>
                                <div>
                                    <label htmlFor="app-stressTestRecoveryMonths" className="text-tiny text-ink-300">Durée récupération (mois)</label>
                                    <Input id="app-stressTestRecoveryMonths" type="number" value={projection.stressTestRecoveryMonths ?? 24} onChange={e => updateProj('stressTestRecoveryMonths', Number(e.target.value))} accent="warning" />
                                </div>
                                <div>
                                    <label htmlFor="app-stressTestInflationShock" className="text-tiny text-ink-300">Choc inflation additionnel (pp)</label>
                                    <Input id="app-stressTestInflationShock" type="number" step="0.5" value={projection.stressTestInflationShock ?? 0} onChange={e => updateProj('stressTestInflationShock', Number(e.target.value))} accent="warning" />
                                </div>
                            </>
                        )}
                    </div>
                ...
                <div className="pt-3 border-t border-white/5">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <Input id="app-monteCarloIterations" type="number" min={MC_ITERATIONS_MIN} max={MC_ITERATIONS_MAX} step={50} value={projection.monteCarloIterations ?? MC_ITERATIONS_DEFAULT} onChange={e => updateProj('monteCarloIterations', Number(e.target.value))} accent="violet" />
                        ...
                        <div>
                            ...
                            <Input id="app-bootstrapBlockSize" type="number" min={12} max={120} step={12} value={projection.bootstrapBlockSize ?? 24} onChange={e => updateProj('bootstrapBlockSize', Number(e.target.value))} accent="violet" />
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                            {projection.divorceEnabled && <>
                                <div>
                                    ...
                                    <Input id="app-divorceAnnualProbability" type="number" step="0.1" value={(projection.divorceAnnualProbability ?? 0.015) * 100} onChange={e => updateProj('divorceAnnualProbability', Number(e.target.value) / 100)} accent="rose" />
                                </div>
                                <div>
                                    ...
                                    <Input type="number" id="app-divorceSplitPct" min={0} max={100} value={projection.divorceSplitPct ?? DIVORCE_SPLIT_PCT_DEFAULT} onChange={e => updateProj('divorceSplitPct', clampSplitPct(Number(e.target.value)))} accent="rose" />
                                </div>
                                <div>
                            ...
                            {projection.ltdEnabled && <>
                                <div>
                                    ...
                                    <Input id="app-ltdAnnualProbability" type="number" step="0.1" value={(projection.ltdAnnualProbability ?? 0.005) * 100} onChange={e => updateProj('ltdAnnualProbability', Number(e.target.value) / 100)} accent="yellow" />
                                </div>
                                <div>
                                    <label htmlFor="app-ltdIncomeReplacementPct" className="text-tiny text-ink-300">% revenu maintenu</label>
                                    <Input id="app-ltdIncomeReplacementPct" type="number" value={projection.ltdIncomeReplacementPct ?? 60} onChange={e => updateProj('ltdIncomeReplacementPct', Number(e.target.value))} accent="yellow" />
                                </div>
                                <div>
                                    <label htmlFor="app-ltdDurationMonths" className="text-tiny text-ink-300">Durée invalidité (mois)</label>
                                    <Input id="app-ltdDurationMonths" type="number" value={projection.ltdDurationMonths ?? 24} onChange={e => updateProj('ltdDurationMonths', Number(e.target.value))} accent="yellow" />
                                </div>
                            </>}
                            {projection.criticalIllnessEnabled && <>
                                <div>
                                    ...
                                    <Input id="app-ciAnnualProbability" type="number" step="0.1" value={(projection.ciAnnualProbability ?? 0.003) * 100} onChange={e => updateProj('ciAnnualProbability', Number(e.target.value) / 100)} accent="pink" />
                                </div>
                                <div>
                            ...
                            {projection.inheritanceEnabled && <>
                                ...
                                <div>
                                    ...
                                    <Input id="app-inheritanceExpectedAtAge" type="number" value={projection.inheritanceExpectedAtAge ?? 60} onChange={e => updateProj('inheritanceExpectedAtAge', Number(e.target.value))} accent="warning" />
                                </div>
                                <div>
                                    <label htmlFor="app-inheritanceUncertaintyYears" className="text-tiny text-ink-300">Incertitude ± années</label>
                                    <Input id="app-inheritanceUncertaintyYears" type="number" value={projection.inheritanceUncertaintyYears ?? 5} onChange={e => updateProj('inheritanceUncertaintyYears', Number(e.target.value))} accent="warning" />
                                </div>
                                <div>
                                    <label htmlFor="app-inheritanceProbability" className="text-tiny text-ink-300">Probabilité 0-1</label>
                                    <Input id="app-inheritanceProbability" type="number" step="0.1" min={0} max={1} value={projection.inheritanceProbability ?? 0.8} onChange={e => updateProj('inheritanceProbability', Number(e.target.value))} accent="warning" />
                                </div>
                            </>}
                            {projection.jobLossEnabled && <>
                                <div>
                                    ...
                                    <Input id="app-jobLossAnnualProbability" type="number" step="0.5" value={(projection.jobLossAnnualProbability ?? 0.03) * 100} onChange={e => updateProj('jobLossAnnualProbability', Number(e.target.value) / 100)} accent="orange" />
                                </div>
                                <div>
                                    <label htmlFor="app-jobLossDurationMonths" className="text-tiny text-ink-300">Durée chômage (mois)</label>
                                    <Input id="app-jobLossDurationMonths" type="number" value={projection.jobLossDurationMonths ?? 6} onChange={e => updateProj('jobLossDurationMonths', Number(e.target.value))} accent="orange" />
                                </div>
                            </>}
                            {projection.modelSurvivor && <>
                                <div>
                                    <label htmlFor="app-rrqSurvivorPct" className="text-tiny text-ink-300">Survivant: % RRQ versé</label>
                                    <Input id="app-rrqSurvivorPct" type="number" value={projection.rrqSurvivorPct ?? 60} onChange={e => updateProj('rrqSurvivorPct', Number(e.target.value))} accent="slate" />
                                </div>
                                <div>
                                    <label htmlFor="app-spouseDbSurvivorPct" className="text-tiny text-ink-300">% DB conjoint conservé</label>
                                    <Input id="app-spouseDbSurvivorPct" type="number" value={projection.spouseDbSurvivorPct ?? 60} onChange={e => updateProj('spouseDbSurvivorPct', Number(e.target.value))} accent="slate" />
                                </div>
                            </>}
                        </div>
                    </div>
                    ...
                    {projection.snowbirdEnabled && (
                        <div className="grid grid-cols-2 gap-3">
                            <div>
                                ...
                                <Input id="app-snowbirdMonthsPerYear" type="number" value={projection.snowbirdMonthsPerYear ?? 5} onChange={e => updateProj('snowbirdMonthsPerYear', Number(e.target.value))} accent="cyan" />
                            </div>
                            <div>
                ...
                <div className="pt-3 border-t border-white/5">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                        ...
                        <div>
                            ...
                            <Input id="app-boomerangStartAge" type="number" value={projection.boomerangStartAge ?? 0} onChange={e => updateProj('boomerangStartAge', Number(e.target.value))} accent="success" />
                        </div>
                        <div>
                            <label htmlFor="app-boomerangDurationMonths" className="text-tiny text-emerald-300">Durée (mois)</label>
                            <Input id="app-boomerangDurationMonths" type="number" value={projection.boomerangDurationMonths ?? 0} onChange={e => updateProj('boomerangDurationMonths', Number(e.target.value))} accent="success" />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <Input id="app-caregivingStartAge" type="number" value={projection.caregivingStartAge ?? 0} onChange={e => updateProj('caregivingStartAge', Number(e.target.value))} accent="success" />
                        </div>
                        <div>
                            <label htmlFor="app-caregivingDurationMonths" className="text-tiny text-emerald-300">Durée (mois)</label>
                            <Input id="app-caregivingDurationMonths" type="number" value={projection.caregivingDurationMonths ?? 0} onChange={e => updateProj('caregivingDurationMonths', Number(e.target.value))} accent="success" />
                        </div>
                    </div>
                </div>
                ...
                <div className="pt-3 border-t border-white/5">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <Input id="app-returnRates-crypto" type="number" step="0.5" value={projection.returnRates?.crypto ?? 10} onChange={e => updateProj('returnRates', { ...projection.returnRates, crypto: Number(e.target.value) })} accent="teal" />
                        </div>
                        <div>
                            <label htmlFor="app-returnRates-cash" className="text-tiny text-ink-300">Rendement cash/HISA annuel (%)</label>
                            <Input id="app-returnRates-cash" type="number" step="0.1" value={projection.returnRates?.cash ?? 3} onChange={e => updateProj('returnRates', { ...projection.returnRates, cash: Number(e.target.value) })} accent="teal" />
                        </div>
                    </div>
                </div>
            </details>
