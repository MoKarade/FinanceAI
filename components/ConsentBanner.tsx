        ...
        >
            ...
            <div className="flex gap-2 shrink-0">
                <button
                    ...
                    className="px-3 py-1.5 rounded-lg bg-white/10 hover:bg-white/20 text-gray-200 text-sm font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-white/40"
                >
                    Refuser
                </button>
                <button
