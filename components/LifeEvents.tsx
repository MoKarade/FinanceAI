...
const getEventInsights = (type: string, amount: number) => {
    switch (type) {
        ...
        case 'BUSINESS': return { breakdown: [{ name: 'Dév/Produit', value: amount * 0.40, color: '#8b5cf6' }, { name: 'Marketing/Pub', value: amount * 0.30, color: '#ec4899' }, { name: 'Légal/Admin', value: amount * 0.10, color: '#6b7280' }, { name: 'Fonds de roulement', value: amount * 0.20, color: '#10b981' }], tips: ['Cash is King : La raison #1 de faillite n\'est pas le manque de profit, mais le manque de liquidités.', 'Coût caché : En tant qu\'autonome, vous devez payer la part employeur ET employé de la RRQ.', 'Conseil : Séparez vos comptes bancaires pro et perso dès le jour 1.'] };
