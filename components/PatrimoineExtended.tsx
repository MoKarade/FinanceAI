                ...
                <div>
                    ...
                    {charity.map((c, i) => (
                        <div key={c.id} className="flex gap-1 mb-1">
                            ...
                            <button onClick={() => { const next = [...charity]; next.splice(i, 1); onCharity(next); }} className="text-danger-400 text-meta p-2 -m-2" aria-label="Supprimer ce don planifié">×</button>
                        </div>
                    ))}
