...
export const PwaInstallBanner: React.FC = () => {
    ...
    return (
        <div
            ...
            className="fixed bottom-4 left-1/2 -translate-x-1/2 z-40 max-w-md w-[calc(100%-2rem)] bg-surface/90 border border-white/10 backdrop-blur-sm rounded-xl shadow-lg p-3 flex items-center gap-3 animate-fade-in"
        >
            ...
            <button
                ...
                className="px-3 py-1.5 rounded-lg bg-primary hover:bg-white text-dark text-meta font-bold transition-colors focus:outline-hidden focus:ring-2 focus:ring-white/40 shrink-0"
            ...
            <button
                ...
                className="inline-flex p-1.5 rounded-lg hover:bg-white/10 text-ink-300 transition-colors focus:outline-hidden focus:ring-2 focus:ring-white/40 shrink-0"
