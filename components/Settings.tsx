          ...
          <Card title="Cles API & Services">
            <div className="space-y-4">
              <div data-focus-section="apiKeys-anthropic">
                ...
                />
                {apiKeys?.anthropic && (
                  <div id="apikey-anthropic-format" className="text-xs mt-1" role="status" aria-live="polite">
              ...
              <div>
                ...
                />
                {apiKeys?.finnhub && (
                  <div id="apikey-finnhub-format" className="text-xs mt-1" role="status" aria-live="polite">
