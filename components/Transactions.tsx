                            ...
                            <div className="space-y-1.5 max-h-48 overflow-y-auto custom-scrollbar">
                                {categorizationRules.map(rule => (
                                    <div key={rule.id} className="flex items-center gap-2 bg-black/30 px-3 py-2 rounded-lg border border-white/5 text-xs group">
                                        ...
                                        <button onClick={() => handleApplyRuleNow(rule)} aria-label={`Appliquer la regle ${rule.pattern}`} className="md:opacity-0 md:group-hover:opacity-100 focus-visible:opacity-100 text-green-400 hover:text-green-300 transition-all text-[10px] font-bold ml-1">Appliquer</button>
            ...
            <Card
                ...
                action={
                    <div className="flex items-center gap-1.5 flex-wrap justify-end">
                        <div className={`text-[10px] sm:text-xs font-bold px-2 py-1 rounded border border-white/10 whitespace-nowrap ${filteredSum > 0 ? 'text-green-400 bg-green-500/10' : 'text-red-400 bg-red-500/10'}`}>
                        ...
                        <button
                            ...
                            className="text-[10px] sm:text-xs flex items-center gap-1 text-blue-300 hover:text-white border border-blue-500/30 bg-blue-500/10 px-2 sm:px-3 py-1.5 rounded-lg transition-colors font-bold disabled:opacity-50 whitespace-nowrap"
                        >
                            {isSyncing ? 'Sync...' : 'Sync'}
                        ...
                        <button
                            ...
                            className="text-[10px] sm:text-xs flex items-center gap-1 text-green-300 hover:text-white border border-green-500/30 bg-green-500/10 px-2 sm:px-3 py-1.5 rounded-lg transition-colors font-bold"
                        >
                            CSV
                        </button>
                        <button
                            ...
                            className="text-[10px] sm:text-xs flex items-center gap-1 text-blue-300 hover:text-white border border-blue-500/30 bg-blue-500/10 px-2 sm:px-3 py-1.5 rounded-lg transition-colors font-bold whitespace-nowrap"
                        >
                            ...
                            >
                                <div className="flex items-start justify-between gap-3 mb-2">
                                    <div className="flex items-start gap-2 min-w-0 flex-1">
                                        ...
                                        <div className="min-w-0 flex-1">
                                            ...
                                            <div className="text-[10px] text-gray-500 mt-0.5">{t.date}</div>
                                        </div>
                                    </div>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <button
                                        ...
                                        aria-pressed={t.isTransfer}
                                        className={`text-[10px] px-2 py-1.5 rounded border transition-colors whitespace-nowrap ${t.isTransfer ? 'bg-blue-500/20 border-blue-500 text-blue-300' : 'bg-white/5 border-white/10 text-gray-400'
                                            }`}
                                    >
                                        {t.isTransfer ? '⇄ Tx' : 'Tx'}
                                    </button>
