...
//    2026-07-23, ADR docs/adr/0007-couverture-du-total-de-la-courbe.md — un TOTAL amputé de plusieurs dizaines de milliers de dollars était pire que l'approximation) ;
...
export const HistoryCoverageNote: React.FC<Props> = ({
    ...
    return (
        <details className="mt-2">
            ...
            <summary className="text-tiny text-ink-400 cursor-pointer select-none hover:text-ink-200 focus-ring rounded-sm py-1.5">
