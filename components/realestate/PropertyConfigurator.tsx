                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            ...
                            {/* [ENG-PAST-OWNED-VS-PLANNED] (A6) : une date passée n'implique plus
                                l'achat — le fait se DÉCLARE (et se corrige) ici. */}
                            {targetDate < new Date().toISOString().split('T')[0] && (
                                <label className="mt-2 flex items-center gap-2 text-meta text-ink-300 cursor-pointer">
                                    <input
                                        type="checkbox"
                                    ...
                                    />
                                    Bien déjà acheté (compté au mois 0 : équité et hypothèque)
                                </label>
                            )}
                        </div>
                    </div>
