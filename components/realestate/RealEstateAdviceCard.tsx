...
interface RealEstateAdviceCardProps {
    ...
    /** [S5-REFONTE-IMMOBILIER] Absent des maquettes : gardé, mais replié (accordéon fermé). */
    replie?: boolean;
}

export const RealEstateAdviceCard: React.FC<RealEstateAdviceCardProps> = ({ context, replie = false }) => {
    ...
    return replie ? (
        <CollapsibleSection icon={<Icon name="sparkles" size={18} />} title="Conseils IA — projet immobilier" subtitle="Coûts cachés, timing, levier fiscal, risques">
            {corps}
        </CollapsibleSection>
    ) : (
