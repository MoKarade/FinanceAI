            ...
            <div className="space-y-3">
                ...
                <label className="block">
                    ...
                    <select
                        ...
                        className="mt-1 w-full bg-surfaceHighlight border border-white/10 rounded-md px-3 py-2 text-body text-ink-100 focus:outline-hidden focus:ring-2 focus:ring-warning-500"
                    >
                        {TEST_PERSONAS.map((p) => (
