  ...
  return (
    <Card title="Mesure d'audience (Google Analytics)">
      <p className="text-sm text-gray-400 mb-3">
        On mesure l'usage de l'app (pages visitées) pour l'améliorer. <strong className="text-gray-300">Aucune
        donnée financière</strong> n'est transmise. Tu peux accorder ou retirer ton consentement à
        tout moment (Loi 25).
      </p>
      <div className="flex flex-wrap items-center gap-3">
        <span className="text-sm text-gray-300" role="status" aria-live="polite">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-lg bg-white/10 hover:bg-white/20 text-gray-200 text-sm font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-white/40 disabled:opacity-40 disabled:cursor-not-allowed"
          >
            Refuser
          </button>
        </div>
