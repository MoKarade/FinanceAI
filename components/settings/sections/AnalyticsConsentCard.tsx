  ...
  return (
    <Card title="Mesure d'audience (Google Analytics)">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <span className="text-body text-ink-200" role="status" aria-live="polite">
        ...
        <div className="flex gap-2">
          <button
            ...
            className="px-3 py-1.5 rounded-lg bg-primary hover:bg-primary/90 text-white text-body font-bold transition-colors focus:outline-none focus:ring-2 focus:ring-primary disabled:opacity-40 disabled:cursor-not-allowed"
          >
            Accepter
          </button>
          <button
            ...
            className="px-3 py-1.5 rounded-lg bg-white/10 hover:bg-white/20 text-ink-100 text-body font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-white/40 disabled:opacity-40 disabled:cursor-not-allowed"
          >
            Refuser
          </button>
        </div>
