...
// [S5-REFONTE-R1] Visite dans l'ordre de la nav : Vue (Futur, Transactions, Budget, Dettes,
// Placements), Planifier (Retraite, Immobilier, Enfants, Projets de vie), Outils (Impôts,
// Assistant, Réglages), puis le Profil (carte en pied de barre).
export const TOUR_STEPS: ReadonlyArray<TourStep> = [
  {
    tab: null,
    title: '👋 Bienvenue dans la visite guidée',
    body: "En 1 minute, je te montre chaque section de l'app. Tout tourne autour de la courbe Future. Tu peux passer à tout moment et relancer la visite depuis Réglages.",
  },
  {
    tab: Tab.FUTURE,
  ...
  },
  {
    tab: Tab.REAL_ESTATE,
    title: '🏡 Immobilier',
    body: "Tes biens et tes projets d'achat au même endroit : mise de fonds, hypothèque, RAP/CELIAPP. Le futur en tient compte automatiquement.",
  },
  {
    tab: Tab.CHILD,
    title: '👶 Enfants',
  ...
  },
  {
    tab: Tab.PROFILE,
    title: '👤 Profil',
    body: "La carte en bas de la barre (dans « Plus » sur mobile) : ton identité, tes salaires et ta situation (seul ou en couple). Tout le reste de l'app lit ces données.",
  },
  {
    tab: null,
    title: '🎉 C\'est tout !',
