...
- [x] **[FISC-TAXDEC-INCR]** ✅ **LIVRÉ 2026-08-20** (PR du lot `claude/taxdec-incr` — GO Marc A2 « code le »). Des 3 sous-claims du triage 2026-06-16, re-tracés sur le code AVANT de coder : **(a) CODÉ** — helper `incrementalBandTax` (par adulte, `familyIncome` évolue AVEC la bande) branché aux bandes §2 gains et §3 dividendes ; l'érosion des crédits d'âge (féd 15 %, QC 361 : 18,75 % du revenu familial) est désormais facturée à la bande. Delta MESURÉ 675,56 $ (68 ans, 60 k$ + 30 k$ gains) — un pin déduit de tête (776,25) était FAUX, récidive `ECRIRE-UN-CHIFFRE-FISCAL-SANS-LE-MESURER`. 3 perturbations discriminantes. Pins ADDITIVITÉ ré-basés 2 776,96→4 220,90 / 7 377,67→7 599,71 (delta = l'érosion nouvellement facturée). **(b) CADUC** — déjà corrigé par `[FISC-STACK-GAINS-DIV]` (#564). **(c) STATU QUO** — FSS sur revenu moyen déjà documenté in situ (plafond 1 000 $/adulte).
