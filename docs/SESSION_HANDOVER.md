...
> à la fin.
>
> ## 📊 Session 2026-07-07 — ORDONNANCEMENT BACKLOG PM : FISC-WELCOME-2026 ✅ #429 + DETTE-RE-SALE ✅ #430 + TP1G-VIVANT-SEUL ✅ (commit 99084b9, PR en cours)
> Exécution **ORDONNÉE du backlog par ordre PM 2026-07-07** (priorité : money-critical + a11y/perf) : **✅ FAIT #1 FISC-WELCOME-2026** (barème taxe de bienvenue « reste QC » 2026 : 3 tranches 62 900/315 000, discrimination 500 k$ = 5 610,50 $, panel `financial-integrity` vert) · **✅ FAIT #3 DETTE-RE-SALE** (vente immo ciblée par `LifeEvent.propertyId` + fallback + sélecteur UI, panel projection-validator 2352/2352 + code-reviewer + silent-failure-hunter APPROVE, suivi LOW `DETTE-RE-SALE-PURGE`) · **⏳ EN COURS #2 TP1G-VIVANT-SEUL** (crédit QC « personne vivant seule » 2 172 $ ligne 361, gate `!hasSpouse` solo+survivant, seuil UNIQUE **42 955 $** remplaçant paliers duaux 27 835/45 270 — **DÉCOUVERTE CRITICAL** : les paliers 45 270/27 835 étaient en fait le seuil du crédit ligne 462 (soutien aux aînés) CONFONDU avec ligne 361, donc la correction retire un bug de sur-crédit couple; discriminant prouvé git-stash, 2352 tests verts, 2 goldens ITEM-2C re-basés) · **Nouveau finding BACKLOG** : `[FISC-LINE361-PERCONJOINT-REDUC]` (réduction 18,75 % ligne 361 appliquée PAR CONJOINT → possible double-comptage couple en bande partielle, pré-existant, à vérifier séparément). **Reste ordre PM** : privacy/a11y/perf + items LOW. **Reste Marc** : envs O4 (jeton relais Vercel), 12 tests manuels. Décisions bloc 2026-07-06 exécutées ✅.
>
