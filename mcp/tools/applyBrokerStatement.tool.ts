...
import { applyBrokerStatementSpec as spec } from './applyBrokerStatement.spec';
import { registerWriteTool } from './_writeTool';
import type { ConfirmVault } from './confirmVault';
import type { StateStore } from '../state/stateStore';

export const registerApplyBrokerStatement = (server: McpServer, store: StateStore, vault?: ConfirmVault): void =>
