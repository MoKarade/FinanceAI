// mcp/tools/simulateWhatIf.spec.ts
// [ARCH-AITOOLS-SPLIT] SPEC pur (browser-safe) — logique VERBATIM de l'ancien tool, sans SDK MCP.
// Enregistrement serveur : simulateWhatIf.tool.ts. Parité app/MCP : tests/aiTools/registryParity.
//
...
export const simulateWhatIfSpec = {
    kind: 'read',
